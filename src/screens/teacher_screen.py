    ...
    with c2:
        ...
        if st.button("Run Face Analysis",width='stretch',type='secondary',icon=':material/analytics:',disabled=not has_photos):
            with st.spinner('Deep Scanning classroom Photos.....'):
                ...
                enrolled_res = supabase.table('subjects_student').select('*,students(*)').eq('subject_id',selected_subjects_id).execute()
...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username=st.text_input(label="Enter UserName",placeholder='@abcd')
    teacher_password=st.text_input(label="Password",type='password',placeholder="Enter your password")
...
def register_teacher(teacher_username,teacher_name,teacher_password,confirm_teacher_password):
    if not teacher_name or not teacher_password or not teacher_username:
    ...
    try:
        ...
        return True,"Successfulyy Created! Login Now"
...
def teacher_screen_Register():
    ...
    st.space()
    teacher_username=st.text_input(label="Enter UserName",placeholder='@abcd')
    teacher_name=st.text_input(label="Enter Name",placeholder='Enter Your Name')
    teacher_password=st.text_input(label="Password",type='password',placeholder="Enter your password")
    confirm_teacher_password=st.text_input(label="confirm Password",type='password',placeholder="Enter your password")
